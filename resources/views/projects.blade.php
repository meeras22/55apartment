...
@section('content')
    ...
    <div class="p-0">
        <div
            ...
            <div class="w-full py-8 space-y-20 bg-fixed bg-center bg-no-repeat bg-contain lg:space-y-24"
                ...
                <div class="space-y-6">
                    ...
                    <p class="max-w-5xl mx-auto">Nestled in the cosmopolitan Abuja, Jahi. L.A Jahi presents a unique
                        ...
                        breathtaking views of the capital. Los Angeles delivers a boutique lifestyle that is second to none.
                        This residence provides an exclusive and safe living experience in the core of Abuja, allowing you
            ...
            <div class="mx-auto space-y-20 text-center max-w-7xl">
